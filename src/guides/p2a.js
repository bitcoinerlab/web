  ...
  return (
    <Guide
      sandboxIframe={
        ...
        <iframe
          src="https://codesandbox.io/embed/github/bitcoinerlab/playground/tree/v3.1.2/descriptors/p2a?fontsize=13&hidenavigation=1&theme=light&view=split&codemirror=0&editorsize=65&forcerefresh=1&hidedevtools=1"
          title="TRUC & P2A"
