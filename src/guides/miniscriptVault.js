...
const MiniscriptVault = () => {
  return (
    <Guide
      sandboxIframe={
        <iframe
          src="https://codesandbox.io/embed/github/bitcoinerlab/playground/tree/main/descriptors/miniscript?fontsize=13&hidenavigation=1&theme=light&view=split&codemirror=0&expanddevtools=1&editorsize=65&forcerefresh=1"
