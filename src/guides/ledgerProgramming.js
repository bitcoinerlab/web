  ...
  return (
    <Guide
      sandboxIframe={
        ...
        <iframe
          src="https://codesandbox.io/embed/github/bitcoinerlab/playground/tree/v1.0.5/descriptors/ledger?fontsize=13&hidenavigation=1&theme=light&view=split&codemirror=0&expanddevtools=1&editorsize=65&forcerefresh=1"
          title="Descriptors"
